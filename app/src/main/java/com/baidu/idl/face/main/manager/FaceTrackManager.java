...
public class FaceTrackManager {
    ...
    public boolean onQualityCheck(final LivenessModel livenessModel,
        ...
        if (livenessModel != null && livenessModel.getFaceInfo() != null) {
            Log.i(MainActivity.TAG,"yaw------------"+Math.abs(livenessModel.getFaceInfo().yaw));
            Log.i(MainActivity.TAG,"roll------------"+Math.abs(livenessModel.getFaceInfo().roll));
            Log.i(MainActivity.TAG,"pitch------------"+Math.abs(livenessModel.getFaceInfo().pitch));
            // 角度过滤
