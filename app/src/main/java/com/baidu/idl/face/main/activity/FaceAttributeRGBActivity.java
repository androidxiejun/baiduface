...
public class FaceAttributeRGBActivity extends BaseActivity implements View.OnClickListener {
...
//         CameraPreviewManager.getInstance().setCameraFacing(CameraPreviewManager.CAMERA_FACING_BACK);
     ...
     * @param height
     */
    public void faceDetect(byte[] data, int width, int height) {
        Log.i(MainActivity.TAG, "faceDetect----------");
        // 无活体检测
    ...
    public String getMsg(FaceInfo faceInfo) {
        ...
        if (faceInfo != null) {
            ...
            msg.append(",").append(faceInfo.race == BDFaceSDKCommon.BDFaceRace.BDFACE_RACE_YELLOW ? "黄种人"
                    ...
                    : "地球人");
            Log.i(MainActivity.TAG, "人脸平行角度-------" + faceInfo.roll);
            Log.i(MainActivity.TAG, "人脸垂直信息-------" + faceInfo.pitch);
            Log.i(MainActivity.TAG, "人脸左右信息-------" + faceInfo.yaw);
        }
        return msg.toString();
    }
