...
//         CameraPreviewManager.getInstance().setCameraFacing(CameraPreviewManager.CAMERA_FACING_BACK);
    ...
    private void checkResult(LivenessModel model) {
        Log.d(MainActivity.TAG, "人脸平行检测------" + model.getFaceInfo().roll);
        Log.d(MainActivity.TAG, "人脸垂直检测------" + model.getFaceInfo().pitch);
        Log.i(MainActivity.TAG, "人脸左右信息-------" + model.getFaceInfo().yaw);
